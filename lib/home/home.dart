...
class _HomeState extends State<Home> {
  ...
  Future<Map> _getGifs() async {
    ...
    if(_search == null)
      ...
      response = await http.get(Uri.parse("https://api.giphy.com/v1/gifs/search?api_key=puPAIAMWM8n1VwYNhUjfgPHQoI31ggXv&q=$_search&limit=19&offset=$_offset&rating=g&lang=en"));
